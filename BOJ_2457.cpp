...
bool is_same_date(date_t A, date_t B) {
...
int main(void) {
	...
	while (compare_date(flowers[i][open], start) || is_same_date(flowers[i][open], start)) {
	...
	while (compare_date(flowers[picked][close], end)) {
		...
		while (compare_date(flowers[i][open], flowers[picked][close]) || is_same_date(flowers[i][open], flowers[picked][close])) {
